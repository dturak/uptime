...
IntervalBuilder.prototype.build = function(begin, end, callback) {
  ...
  async.auto({
    initialState: function(next) {
      ...
      console.log(self.determineInitialState(begin, next));
    },
    interval: ['initialState', function(options, next) {
      console.log("buildIntervalsForPeriod");
      console.log(self.buildIntervalsForPeriod(begin, end, next));
    }],
    check: ['initialState', 'interval', function (options, next) {
      console.log("getCurrentCheck");
      console.log(self.getCurrentCheck(options, next));
    }],
    duration: ['initialState', 'interval', 'check', function (options, next) {
      if (typeof options.check !== 'undefined' && options.check !== null) {
        ...
        console.log(self.calculateDuration(options.check, begin, end, next));
      }
    }],
    downtime: ['initialState', 'interval', 'check', 'duration', function (options, next) {
      if (typeof options.check !== 'undefined' && options.check !== null) {
        console.log("calculateDowntime");
        console.log(self.calculateDowntime(options.check, begin, end, next));
      };
    }]
