...
QosAggregator.prototype.aggregatePingsIntoStatsGroupedByCheck = function(start, end, callback) {
  ...
  async.waterfall([
    function (next) {
      next(null, start, end)
    }, // pass the parameters to the next function
    function (arg1, arg2, next) {
      _this.aggregatePingsByCheck(arg1, arg2, next)
    },
    function (arg1, next) {
      _this.getCheckStats(arg1, next)
    }
  ], function(err, result) {
    callback(err, result)
  });
